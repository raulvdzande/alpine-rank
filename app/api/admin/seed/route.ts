...
const RESORTS = [
  ...
  { name: "Bad Gastein", country: "Austria", region: "Salzburg", top: 2250, base: 740, km: 110, blue: 38, red: 40, black: 22, lifts: 29, price: 48, lat: 47.42, lon: 13.13, category: "Intermediate" },
  { name: "Hintertux", country: "Austria", region: "Tyrol", top: 3250, base: 1500, km: 80, blue: 35, red: 45, black: 20, lifts: 24, price: 55, lat: 47.27, lon: 11.52, category: "Intermediate" },
  // Switzerland (8)
  ...
  { name: "Interlaken-Jungfrau", country: "Switzerland", region: "Bern", top: 3454, base: 568, km: 213, blue: 40, red: 35, black: 25, lifts: 44, price: 59, lat: 46.57, lon: 8.18, category: "Intermediate" },
  { name: "Grindelwald-First", country: "Switzerland", region: "Bern", top: 2502, base: 1050, km: 62, blue: 45, red: 35, black: 20, lifts: 20, price: 53, lat: 46.63, lon: 8.34, category: "Beginners" },
  // France (8)
  ...
  { name: "Tignes", country: "France", region: "Savoie", top: 3600, base: 2100, km: 300, blue: 30, red: 45, black: 25, lifts: 57, price: 59, lat: 45.47, lon: 6.90, category: "Expert" },
  { name: "Saint-Gervais", country: "France", region: "Haute-Savoie", top: 3844, base: 1385, km: 155, blue: 28, red: 44, black: 28, lifts: 31, price: 54, lat: 45.87, lon: 6.71, category: "Expert" },
  // Italy (6)
  ...
  { name: "Dolomiti Superski", country: "Italy", region: "South Tyrol", top: 2939, base: 1420, km: 1200, blue: 40, red: 38, black: 22, lifts: 155, price: 61, lat: 46.45, lon: 11.85, category: "Intermediate" },
  // Scandinavia (9)
  ...
  { name: "Lillehammer", country: "Norway", region: "Oppland", top: 1102, base: 370, km: 53, blue: 44, red: 36, black: 20, lifts: 24, price: 43, lat: 61.26, lon: 10.47, category: "Beginners" },
  // Germany (4)
  ...
  { name: "Mittenwald", country: "Germany", region: "Bavaria", top: 2244, base: 915, km: 28, blue: 46, red: 34, black: 20, lifts: 8, price: 42, lat: 47.43, lon: 11.26, category: "Beginners" },
  { name: "Berchtesgaden", country: "Germany", region: "Bavaria", top: 1874, base: 602, km: 22, blue: 48, red: 32, black: 20, lifts: 6, price: 40, lat: 47.62, lon: 12.60, category: "Beginners" },
  // Spain/Pyrenees (4)
  ...
  { name: "La Molina", country: "Spain", region: "Catalonia", top: 2445, base: 1700, km: 63, blue: 44, red: 36, black: 20, lifts: 14, price: 44, lat: 42.40, lon: 1.81, category: "Beginners" },
  // Eastern Europe (11)
  ...
  { name: "Poprad-Tatras", country: "Slovakia", region: "High Tatras", top: 2499, base: 1010, km: 75, blue: 42, red: 38, black: 20, lifts: 12, price: 25, lat: 49.17, lon: 20.25, category: "Intermediate" },
  { name: "Kranjska Gora", country: "Slovenia", region: "Julian Alps", top: 1844, base: 800, km: 35, blue: 46, red: 34, black: 20, lifts: 11, price: 38, lat: 46.49, lon: 13.98, category: "Beginners" },
  { name: "Krvavec", country: "Slovenia", region: "Karavanke", top: 1971, base: 1270, km: 36, blue: 44, red: 36, black: 20, lifts: 8, price: 36, lat: 46.30, lon: 14.57, category: "Beginners" },
  { name: "Bohinj", country: "Slovenia", region: "Julian Alps", top: 1800, base: 520, km: 28, blue: 48, red: 32, black: 20, lifts: 6, price: 34, lat: 46.27, lon: 13.97, category: "Beginners" },
  { name: "Donovaly", country: "Slovakia", region: "Low Tatras", top: 1273, base: 550, km: 40, blue: 45, red: 35, black: 20, lifts: 9, price: 22, lat: 48.81, lon: 19.48, category: "Beginners" },
  { name: "Štrbské Pleso", country: "Slovakia", region: "High Tatras", top: 2002, base: 1346, km: 42, blue: 44, red: 36, black: 20, lifts: 10, price: 26, lat: 49.12, lon: 20.02, category: "Beginners" },
];
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`✅ Seeded ${seeded} resorts successfully!`);
    return NextResponse.json({
      success: true,
      message: `Seeded ${seeded} resorts successfully`,
      count: seeded,
    });
  } catch (error) {
